# app_assignments.py — Assignments Chatbot (non-spoiler) with dual retrieval & debug
...
# --- Debug toggle & logger (works online) ---
...
def show_debug_table(pairs: List[Tuple[Any,float]], header: str = "Top hits"):
...
# -------------------- Sidebar: self-test --------------------
if st.sidebar.button("Run retrieval self-test"):
    info = {
